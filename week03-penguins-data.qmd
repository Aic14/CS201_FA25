...
url_gentoo.penguin <- "https://pasta.lternet.edu/package/data/eml/knb-lter-pal/219/3/002f3893385f710df69eeebe893144ff"

gentoo.penguin_data_from_url <- read_csv(url_gentoo.penguin)
```
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram() +
  theme_bw() +
  scale_fill_manual(values = c("darkorange","darkorchid","brown")) +
